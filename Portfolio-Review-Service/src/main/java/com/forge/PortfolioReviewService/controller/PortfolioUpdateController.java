...
public class PortfolioUpdateController {
	...
	//removed technologies and Responsibilities 
	@Autowired
...
//	public SkillMatrixItems getSkillMatrixItem(@RequestParam int id) {
...
//	public String updateSkillMatrixItem(@RequestBody SkillMatrixItems skillMatrixItem) {
