...
public class ServiceController {
	...
	@Autowired
	private PortfolioItemsRepo potIRepo; //potfolio4lyfe
	
	
	@Autowired
	private AboutMeRepo aRepo; //testing
	
//	@Autowired
//	private PortfolioItemsRepo<AboutMe> potARepo; //potfolio4lyfe
	...
	public String getPortfolioItems(){
		PortfolioItems newA = new AboutMe(1,1, "all bananas");
		potIRepo.save(newA);
		//List<PortfolioItems> myList = potIRepo.findAll();
		String myList = "it works!";
		return myList;
	}
